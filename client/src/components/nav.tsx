...
export default function Nav({
  ...
  return (
    <div
      ...
      className={cn(
        'group bg-background border-b py-2 transition-[max-height,padding] duration-500 data-[collapsed=true]:py-2 md:border-none',
        className
      )}
    >
  ...
  return (
    <Link
      ...
      className={cn(
        ...
        'h-12 justify-start rounded-none px-6 text-wrap',
