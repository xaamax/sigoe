...
import { openNotificationErrors } from "@/core/hooks/sweet-alert";
import { getAuth, setAuth, clearAuth } from "../providers/auth-storage";
...
const tratarCatch = (
  ...
  if (messages.length) openNotificationErrors(messages);
