...
const getOcorrencias = (): Promise<ApiResult<OcorrenciaRegistroDTO[]>> =>
    get(URL_GESTAO_OCORRENCIAS);


  const submitOcorrencia = async (payload: SalvarOcorrenciaDTO) => {
  ...
  export default { getOcorrencias, submitOcorrencia };
